...
export const PROJECT_NAME = process.env.PROJECT_NAME || 'Box Firmware';
export const CUSTOM_PROPERTIES_FILE =
  process.env.CUSTOM_PROPERTIES_FILE || '/var/box_props.json';

export const API_URL = process.env.API_URL || 'http://localhost:3500';
export const API_PORT = process.env.API_PORT || '3500';

export const SESSION_KEY =
  process.env.SESSION_KEY || '339Mdea2MxaJj5AZAuJcrpIfqlzzBGFd246E7AEE74F69F1E';
...
export const SSID = process.env.SSID || 'Box';
export const IPADDRESS = process.env.IPADDRESS || '192.168.88.1';
export const SUBNET_RANGE_START =
  process.env.SUBNET_RANGE_START || '192.168.88.100';
export const SUBNET_RANGE_END =
  process.env.SUBNET_RANGE_END || '192.168.88.200';

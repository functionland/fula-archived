...
export const mockDid = 'did:fula:QmUTE4cxTxihntPEFqTprgbqyyS9YRaRcC8FXp6PACEjFG';
...
export const mockPublickKey1 = {
    id: 'did:fula:QmUTE4cxTxihntPEFqTprgbqyyS9YRaRcC8FXp6PACEjFG#PK1',
...
export const mockPublickKey2 = {
    id: 'did:fula:QmUTE4cxTxihntPEFqTprgbqyyS9YRaRcC8FXp6PACEjFG#PK2',
    controller: 'did:fula:QmUTE4cxTxihntPEFqTprgbqyyS9YRaRcC8FXp6PACEjFG',
    type: 'myType2',
    publicKeyHex: '4D5E6F',
};
...
export const mockService1 = {
    id: 'did:fula:QmUTE4cxTxihntPEFqTprgbqyyS9YRaRcC8FXp6PACEjFG;Service1',
    type: 'myServiceType',
    serviceEndpoint: 'http://service.foo.bar',
};

export const mockService2 = {
    id: 'did:fula:QmUTE4cxTxihntPEFqTprgbqyyS9YRaRcC8FXp6PACEjFG;Service2',
    type: 'myServiceType',
